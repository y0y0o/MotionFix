...
original = np.load("data/test_inputs/momask_50/no_ik/p000021_rotation_person_is_walking_normally_in_a.npy").astype(np.float32)
...
ckpt = torch.load("checkpoints/v13/latest.pth", map_location=device)
