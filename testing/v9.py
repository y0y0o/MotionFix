...
from models.v9 import MotionFixNetworkV9
...
def main():
    ...
    parser.add_argument('--checkpoint', type=str, default='checkpoints/v9/best.pth',
    ...
    momask_dir = os.path.expanduser("data/test_inputs/momask_50")
    all_summaries = []
    ...
    if args.both or not args.ik:
        summary = run_test(
            ...
            output_dir="outputs/fixed/v9_no_ik",
    ...
    if args.both or args.ik:
        summary = run_test(
            ...
            output_dir="outputs/fixed/v9_ik",
