...
sys.path.insert(0, os.path.expanduser("~/projects/T2M-GPT"))
...
def main():
    ...
    mean_path = os.path.expanduser("~/projects/mdm/dataset/t2m_mean.npy")
    std_path = os.path.expanduser("~/projects/mdm/dataset/t2m_std.npy")
    ...
    # 读取所有 T2M-GPT 输出
    t2mgpt_dir = os.path.expanduser("~/projects/T2M-GPT/output_batch50")
    ...
    # 创建输出目录
    output_dir = "outputs/fixed/t2mgpt"
    raw_dir = "data/test_inputs/t2mgpt"
